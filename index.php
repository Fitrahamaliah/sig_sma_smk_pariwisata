...
<head>
  ...
  <title>SIG SEKOLAH & WISATA</title>
      ...
      <div class="header-container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li><a href="#portfolio">Data Instansi Dan Wisata</a></li>
...
<!--                 <li><a href="#">Drop Down 4</a></li>
            ...
            <li class="get-started"><a href="#about">START</a></li>
          </ul>
        </nav><!-- .nav-menu -->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      ...
      <h1>SMA & SMK Negeri Dan Pariwisata</h1>
      <h2>Di Surabaya</h2>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <h2>SIG SMA & SMK NEGERI DAN PARIWISATA SURABAYA</h2>
            <h3>Sistem informasi ini merupakan aplikasi pemetaan geografis sekolah menengah dan objek wisata di wilayah Surabaya. Aplikasi ini memuat informasi dan lokasi dari SMA, SMK dan wisata di Surabaya.</h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p>
              Dalam aplikasi pemetaan geografis sekolah menengah ini memuat informasi dan lokasi dari SMA, SMK dan Objek Wisata di Surabaya. Pemetaan diambil dari data lokasi Google Maps dan data dari website masing" sekolah & wisata. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
            <ul>
              ...
              <li><i class="ri-check-double-line"></i> Objek Wisata</li>
            </ul>
            <p class="font-italic">
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <?php
            ...
            ?>
          <div class="col-lg-3 col-6 text-center">
            <span data-toggle="counter-up"><?php echo $wisata; ?></span>
            <p>Objek Wisata</p>
          </div>
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center" data-aos="zoom-in">
          <h3>SIG</h3>
          <p> Detail sekolah menengah negeri atau pariwisata di Surabaya</p>
        ...
        <div class="panel-body" style="align-content: center;">
          <div id="map" style="width:100%;height:480px;"></div>
            <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyDs835teuMFEjpu4Dxnv90gnPFQZiVMn_g"></script>
              ...
              var officeLocations = [
              <?php
              $data = file_get_contents('http://localhost/sistem-informasi-geografis-sekolah-main/ambildata.php');
                              $no=1;
        ...
        <div class="row">
          <div class="col-lg-3" data-aos="fade-right">
            <div class="section-title">
              <h2>Data SMA, SMK Dan Pariwisata</h2>
              <p>Halaman ini memuat informasi SMA, SMK dan Pariwisata di Surabaya. </p>
            </div>
          </div>
          ...
          <div class="panel panel-info panel-dashboard">
            ...
            <div class="panel-body">
              ...
              <thead>
                <tr>
                  <th width="5%">No.</th>
                  <th width="30%">Nama Sekolah atau Wisata</th>
                  <th width="10%">NPSN</th>
        ...
        <div class="row">
          ...
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="info mt-4">
              ...
              <h4>Lokasi:</h4>
              <p> Universitas Negeri Surabaya Jl. Ketintang, Ketintang, Kec. Gayungan, Kota SBY, Indonesia 60231</p>
            </div>
            <div class="row">
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>SIG SMA,SMK&Pariwisata</span></strong>.
        </div>
        <div class="credits">
